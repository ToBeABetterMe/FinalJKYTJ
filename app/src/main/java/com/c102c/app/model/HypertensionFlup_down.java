...
// KEEP INCLUDES END
/**
 * Entity mapped to table "HYPERTENSION_FLUP_DOWN".
 */
public class HypertensionFlup_down {
	...
	public HypertensionFlup_down(String businessKey) {
		this.businessKey = businessKey;
	}

	public HypertensionFlup_down(String businessKey, String specialNo,
			String personId, String bloodPressureLevel,
			String healthFileNumber, String name, String flupDate,
			...
			String nextFlupDate, String drugDosage, String drugDosageAdd) {
		this.businessKey = businessKey;
