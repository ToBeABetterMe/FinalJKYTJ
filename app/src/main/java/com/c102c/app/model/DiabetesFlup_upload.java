...
// KEEP INCLUDES END
/**
 * Entity mapped to table "DIABETES_FLUP_UPLOAD".
 */
public class DiabetesFlup_upload {
	...
	public DiabetesFlup_upload(Long id) {
		this.id = id;
	}

	public DiabetesFlup_upload(Long id, String personId, String specialNo,
			...
			String bmi, String dorsalisPedisPulseCode, String signsOther,
