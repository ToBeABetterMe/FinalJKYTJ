...
/** 
 * DAO for table "HYPERTENSION_FLUP_UPLOAD".
*/
public class HypertensionFlup_uploadDao extends AbstractDao<HypertensionFlup_upload, Long> {

    public static final String TABLENAME = "HYPERTENSION_FLUP_UPLOAD";

    /**
     * Properties of entity HypertensionFlup_upload.<br/>
    ...
    */
    ...
    public HypertensionFlup_uploadDao(DaoConfig config) {
        super(config);
    }
    
    public HypertensionFlup_uploadDao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(SQLiteDatabase db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"HYPERTENSION_FLUP_UPLOAD\" (" + //
    ...
    public static void dropTable(SQLiteDatabase db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "\"HYPERTENSION_FLUP_UPLOAD\"";
        db.execSQL(sql);
    }

    /** @inheritdoc */
    @Override
    protected void bindValues(SQLiteStatement stmt, HypertensionFlup_upload entity) {
        stmt.clearBindings();
    ...
    /** @inheritdoc */
    @Override
    public HypertensionFlup_upload readEntity(Cursor cursor, int offset) {
        HypertensionFlup_upload entity = new HypertensionFlup_upload( //
    ...
    /** @inheritdoc */
    @Override
    public void readEntity(Cursor cursor, HypertensionFlup_upload entity, int offset) {
    ...
    /** @inheritdoc */
    @Override
    protected Long updateKeyAfterInsert(HypertensionFlup_upload entity, long rowId) {
        entity.setId(rowId);
        return rowId;
    }
    ...
    /** @inheritdoc */
    @Override
    public Long getKey(HypertensionFlup_upload entity) {
        if(entity != null) {
            return entity.getId();
        } else {
            return null;
