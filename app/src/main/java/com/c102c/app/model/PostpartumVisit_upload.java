...
// KEEP INCLUDES END
/**
 * Entity mapped to table "POSTPARTUM_VISIT_UPLOAD".
 */
public class PostpartumVisit_upload {
	...
	public PostpartumVisit_upload(Long id) {
		this.id = id;
	}

	public PostpartumVisit_upload(Long id, String personId, String specialNo,
			String machineCode, String machineNo, String pregnantManualNo,
			String name, String flupDate, String temperature,
			String healthDesc, String psychologicStatus, String SBP,
			String DBP, String breastCode, String breastDesc,
			String lochiaCode, String lochiaDesc, String uterusCode,
			String uterusDesc, String woundCode, String woundDesc,
			String other, String typeCode, String typeDesc, String guideCodes,
			String guideOther, String referralCode, String referralReason,
			String referralOrg, String referralDepartment,
			String visitDoctorCode, String visitDoctorName,
			String visitOrgCode, String visitOrgName, String nextFlupDate,
			String processCode) {
		this.id = id;
