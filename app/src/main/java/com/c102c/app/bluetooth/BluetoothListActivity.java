...
public class BluetoothListActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		// Set result CANCELED incase the user backs
		// out
	...
	// The on-click listener for all devices in the
	// ListViews
	...
	// The BroadcastReceiver that listens for
	...
	private final BroadcastReceiver mReceiver = new BroadcastReceiver() {
		...
		public void onReceive(Context context, Intent intent) {
			...
			if (BluetoothDevice.ACTION_FOUND.equals(action)) {
				...
				// When discovery is finished, change
				// the Activity title
